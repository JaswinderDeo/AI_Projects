...
# Load and prepare data for vector store (do this once during initialization)
...
rag_tool = create_retriever_tool(
    ...
    name="HealthcareDocsRAG",
    description="Use this tool to find relevant information in internal healthcare documents."
)
